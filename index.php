...
<header data-parallax="scroll" data-image-src="img/header.jpg" id="top">
  <h1>Baron Osy</h1>
  <img src="img/logo.png">
  <p>Een romantisch weekend, citytrip of vergaderen?<br> BARON OSY combineert modern comfort en<br> sereniteit in een historisch kader.</p>
</header>
...
<center>
  <nav>
    <a href="#" class="tablinks" onclick="openTab(event, 'ruimtes')" id="link-ruimtes">Polyvalente ruimtes</a>
    <a href="#" class="tablinks" onclick="openTab(event, 'suites')" id="link-suites">Suites</a>
    <a href="#" class="tablinks" onclick="openTab(event, 'contact')" id="link-contact">Contact</a>
  </nav>
</center>

<div id="ruimtes" class="content">

<center>
    <div class="subnav">
        <a href="#bel-etage">Bel-etage</a>
        <a href="#eerste-verdiep">Eerste verdiep</a>
...
<div class="content__row">
  <div class="content__col">
    <div class="content__txt">
     <p>Vergader in alle rust in een stijlvol kader die geschiedenis ademt. Bij <b>Baron Osy</b> heeft u net dat tikkeltje extra, voor al uw vergaderingen, meetings, demonstraties, proeverijen, productvoorstellingen, workshops, events,… <b>zowel privé als professioneel</b>, uiteraard steeds binnen de geest en het concept van het huis.</p>

    <p><b>Baron Osy</b> beschikt over twee originele- en inspirerende ruimtes met twee verschillende capaciteiten, in de authentieke <b>bel-etage</b> of op het <b>eerste verdiep</b>.</p>
    
    <p><b>Per dagdeel / dag / periode te huren.</b></p>
     
     <div class="content__hide">
     <p class="mb-5">Wij werken voor u een <b>formule op maat</b> uit, met mogelijkheid tot:</p>

     <ul>
        <li>overnachten in onze luxe kamers</li>
        <li>diverse cateringformules</li>
        <li>technische ondersteuning</li>
        <li>verpozen in de binnentuin</li>
     </ul>

    <p class="mb-5"><b>Inbegrepen</b> in het bedrag van uw zaalhuur:</p>

    <ul>
      <li>zaal in opstelling van uw keuze</li>
      <li>1 flipchart</li>
      <li>gratis wifi ter beschikking</li>
      <li>schrijfpapier, schrijfgerief, water en vergader-snoepjes </li>
      <li>scherm en beamer (op aanvraag)</li>
    </ul>
  ...
  <div class="content__col">
    <div class="content__img" style="background-image:url(img/foto-7509.jpg)"></div>
  </div>
  <div class="content__clear"></div>
</div>

<div class="content__row" id="bel-etage">
  <div class="content__col">
     <div class="content__img" style="background-image:url(img/foto-2.jpg)"></div> 
  </div>
 <div class="content__col">
    <div class="content__txt">
     <h3>Bel-etage</h3>
     <ul>
      <li>oppervlakte: 45m²</li>
      <li>u-vorm = 16 personen</li>
      <li>theaterstijl = 49 personen</li>
      <li>schoolstijl = 20 personen</li>
      <li>staande receptie = 49 personen</li>
      <li>mogelijkheid tot combinatie met keukentje (8,50 m²)</li>
...
<div class="content__row" id="eerste-verdiep">
  <div class="content__col">
    <div class="content__txt">
     <h3>Eerste verdiep</h3>
     <ul>
      <li>oppervlakte: 21m²</li>
      <li>u-vorm = 16 personen</li>
      <li>theaterstijl = 30 personen</li>
      <li>schoolstijl = 24 personen</li>
      <li>staande receptie = 49 personen</li>
      <li>toegang tot balkon</li>
    ...
    <ul>
     ...
     <div class="content__img" style="background-image:url(img/foto-7643.jpg)"></div> 
  </div>
 
  <div class="content__clear"></div>
</div>

<div class="content__row" id="catering">
  <div class="content__col">
    <div class="content__img" style="background-image:url(img/foto-7750.jpg)"></div>
  </div><div class="content__col">
    <div class="content__txt">
     <h3>Catering</h3>
     <p>Mogelijkheid van verschillende <b>cateringformules</b>: broodjes, lunch-buffet, koffiebreaks, receptie, drankenforfaits,… <b>eigen</b> catering is ook mogelijk.</p>
    </div>
  </div>
...
<div class="content__row" id="faciliteiten">
  <div class="content__col">
    <div class="content__txt">
     <h3>Faciliteiten</h3>

     <p>Een meerdaags congres of een late vergadering? U kan <b>overnachten</b> in een uniek kader en heeft de keuze uit een waaier aan <a href="#" onclick="openTab(event, 'suites', true)">suites</a>, inclusief een verzorgd ontbijt met bediening.</p>

     <p class="mb-5">Wij bieden eveneens aan:</p>
     <ul>
       <li>technische ondersteuning</li>
       <li>gratis wifi</li>
       <li>binnentuin</li>
     ...
     <p><b>Heeft u verdere vragen</b>? Stel ze gerust. Wij leveren een <b>flexibele service</b>. Ons team staat voor u klaar.</p>   
    
     </div>
    </div><div class="content__col">
     <div class="content__img" style="background-image:url(img/foto-4.jpg)"></div> 
  </div>
 
  <div class="content__clear"></div></div>
  
<div class="content__row" id="geschiedenis">
  <div class="content__col">
  ...
  <div class="content__clear"></div></div><div class="content__row" id="bereikbaarheid">
    <div class="content__col">
      <div class="content__txt">
       <h3>Bereikbaarheid</h3>
       <p><b>Baron Osy</b> is gemakkelijk bereikbaar per:</p>

        <ul>
            <li><b>auto</b>: u neemt afslag Borgerhout op de Antwerpse Ring op slechts 1,5 km en parkeert best in een zeer nabijgelegen parkeergarage op 1 minuut stappen</li>
            <li><b>trein</b>: het treinstation Antwerpen - Berchem is slechts op 5 minuten stappen</li>
            <li><b>vliegtuig</b>: de luchthaven van Deurne ligt op slechts 2,5 km. Indien gewenst zorgen we voor transfer naar Baron Osy.</li>
            <li><b>per bus of tram 4 &amp; 11 of premetro 9</b>: halte op 1 minuut stappen van Baron Osy</li>
        </ul>
    ...
    <div class="content__col">
      ...
      <form id="contact-form-1" name="contact" method="post" novalidate="novalidate">  
        <div class="form__row">
          <label for="name" id="name">Naam<span class="required">*</span></label>
          <input type="text" name="name" id="name" size="30" value="" required="" class="form__text">
        </div>
        <div class="form__row">
          <label for="email" id="email">Email<span class="required">*</span></label>
          <input type="text" name="email" id="email" size="30" value="" required="" class="form__text">
        </div>
        <div class="form__row"> 
          <label for="message" id="message">Bericht<span class="required">*</span></label>
          <textarea name="message" id="message" required="" class="form__text"></textarea>
        </div>
        <div class="form__row"> 
      ...
      <div class="msg-error">Er is iets fout gelopen, probeer later opnieuw.</div>
    </div></div><div class="content__clear"></div></div>
...
<div id="contact" class="content">
  <div class="content__row">
    <div class="content__col">
      ...
      <div class="msg-success">Bedankt, uw bericht is verzonden!</div>
      <div class="msg-error">Er is iets fout gelopen, probeer later opnieuw.</div>
    </div></div><div class="content__col">
...
<footer>
    <span>&copy; Baron Osy <?php echo date("Y"); ?></span> &dash; fotografie Richard De Nul
</footer>

<a href="#top" id="scrolltop"><i class="flaticon-up-arrow"></i></a>
...
<script>
  ...
  document.getElementById("link-ruimtes").click();
  function openTab(e, tab, scroll) {
    e.preventDefault();   
    ...
    document.getElementById('link-' + tab).className += " active";
  ...
  $(function() {
    $(".button__more").click(function(e){
      ...
      $this.toggleText($this.attr('data-show'), $this.attr('data-hide'));
    });
  });
